...
# definerer viskositet på nytt slik at det matcher artikkelen til Josefin:
...
function pstokes_CutFEM_navier(;n, u_exact, p_exact, f, g, ud, order, geometry, βu0, γu1, γu2, γp, βp0, nu, stabilize, δ, save = false, calc_condition = false)
    """    
    """
